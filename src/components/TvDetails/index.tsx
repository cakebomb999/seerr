...
const messages = defineMessages('components.TvDetails', {
  ...
  maluserscore: 'MyAnimeList Score ({formattedCount} ratings)',
          ...
          <div className="media-facts">
            {(!!data.voteCount ||
              ...
              <div className="media-ratings">
                ...
                {!!ratingData?.mal?.score && (
                  <Tooltip
                    content={intl.formatMessage(messages.maluserscore, {
                      formattedCount: intl.formatNumber(
                        ratingData.mal.scoreCount,
                        {
                          notation: 'compact',
                  ...
                  >
                    <a
                      href={ratingData.mal.url}
                      className="media-rating"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <span className="mr-1 font-bold text-indigo-400">
                        MAL
                      </span>
                      <span>{ratingData.mal.score}</span>
                    </a>
                  </Tooltip>
                )}
                {!!data.voteCount && (
